...
fun getHomeMoviesList() : ArrayList<Movie> = arrayListOf(
...
fun getFavoritesMoviesList() : ArrayList<Movie> = arrayListOf(
...
fun getRatingMoviesList() : ArrayList<Movie> = arrayListOf(
